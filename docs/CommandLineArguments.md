...
Utilización de los argumentos desde la línea de commando para parametrizar una aplicación.

### Configuración
La libería debe estar en el repositorio de librerías (ej. ```C:\Repositories\cxxopts\```), tanto fuentes, dll y lib

## Librería
Se utiliza la librería __jarro2783/cxxopts__
[Travis-ci](https://travis-ci.org/github/jarro2783/cxxopts)
...
->C/C++ Directories->
-->Include Directories: C:\Repositories\cxxopts\include
```

## Testing
[Proyecto VS2019](/src/test/cxxopts_test/)

### README.md
Copia de /jarro2783/cxxopts
